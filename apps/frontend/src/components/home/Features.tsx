            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Discover all the powerful features that make ChatSpace the perfect platform for your
                        conversations.
                    </p>
                </motion.div>
    ...
    return (
        ...
        >
            <div className="flex items-center mb-4">
                <div className="p-2 bg-indigo-50 dark:bg-indigo-900/20 rounded-lg">{icon}</div>
